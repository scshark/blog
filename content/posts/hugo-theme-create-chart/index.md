---
title: "Hugo主题Doit---如何创建图表"
date: 2022-09-13T16:22:31+08:00
draft: false
authors: ["Alan"]
tags: ["hugo","hugo-theme","diagram"]
categories: ["hugo"]
...
如果你不得不使用旧版的 Hugo，你可以使用 [`mermaid` shortcode]({{< relref "../hugo-theme-extend-shortcodes/index.md/#5-mermaid" >}})。
{{< /admonition >}}
